  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-xl shadow-xl w-96 relative">
        ...
        <h4 className="text-lg font-semibold mb-4">Rate this Response</h4>
        ...
        <textarea
          ...
          className="w-full border rounded-lg p-2.5 text-sm mb-4 outline-none focus:ring-2 focus:ring-primary-300"
