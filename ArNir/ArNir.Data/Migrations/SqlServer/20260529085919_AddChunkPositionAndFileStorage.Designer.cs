...
namespace ArNir.Data.Migrations.SqlServer
{
    ...
    [Migration("20260529085919_AddChunkPositionAndFileStorage")]
    partial class AddChunkPositionAndFileStorage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArNir.Core.Entities.AgentRunLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ArNir.Core.Entities.ChatMemory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("EmbeddingRefId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ArNir.Core.Entities.DocumentChunk", b =>
                {
                    ...
                    b.Property<float?>("BboxX1")
                        .HasColumnType("real");

                    b.Property<float?>("BboxX2")
                        .HasColumnType("real");

                    b.Property<float?>("BboxY1")
                        .HasColumnType("real");

                    b.Property<float?>("BboxY2")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("ArNir.Core.Entities.EvaluationResultEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("RelatedHistoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RelatedHistoryId");

                    b.ToTable("EvaluationResults");
                });

            modelBuilder.Entity("ArNir.Core.Entities.ExportHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArNir.Core.Entities.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArNir.Core.Entities.MetricEventEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArNir.Core.Entities.PlatformSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArNir.Core.Entities.PromptTemplateEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ArNir.Core.Entities.EvaluationResultEntity", b =>
                {
                    b.HasOne("ArNir.Core.Entities.RagComparisonHistory", "RelatedHistory")
                        .WithMany()
                        .HasForeignKey("RelatedHistoryId");

                    b.Navigation("RelatedHistory");
                });
